...
export function GoalProgressCard({ goal, onClick }: GoalProgressCardProps) {
    ...
    return (
        ...
        >
            ...
            <h4 className="font-semibold text-slate-900 dark:text-slate-100 mb-2 line-clamp-1 font-heading">
                {goal.title}
            </h4>
            ...
            <div className="flex items-center gap-1.5 text-[10px] font-medium uppercase text-slate-500 dark:text-slate-400">
