      ...
      `}
            ...
            `}>
                    ...
                    <div className="relative flex-shrink-0">
                        <button
                            ...
                            className="p-1 rounded-lg opacity-0 group-hover:opacity-100 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all font-heading"
                        >
                        ...
                        {menuOpen && (
                            <>
                                ...
                                <div className="absolute right-0 top-8 z-20 w-44 bg-white dark:bg-slate-800 rounded-lg shadow-lg border border-slate-200 dark:border-slate-700 py-1">
                                    ...
                                    <div className="px-3 py-1.5 text-[10px] uppercase font-bold text-slate-500 dark:text-slate-400 tracking-wider">
                                        Cambiar estado
                                    </div>
                ...
                {/* Title */}
                <h3 className={`
          font-bold text-lg leading-snug mb-2 font-heading
          ${goal.status === 'completada'
        ...
        `}>
                ...
                <div className="flex items-center gap-4 mb-4">
                    ...
                    {totalTasks > 0 && (
                        <div className="flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-tight text-slate-500 dark:text-slate-400">
                            <ListTodo className="w-3.5 h-3.5 text-violet-500/70" />
                ...
                <div className="flex items-center flex-wrap gap-1.5 mb-4">
                    {goal.tags.map(tag => (
                        <span
                            key={tag}
                            className={`inline-flex items-center px-2 py-0.5 rounded-lg text-[10px] uppercase font-bold tracking-wider ${tagColors[tag] || 'bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-400'}`}
                        >
                            {tag}
                        </span>
                    ))}
          ...
          `}>
                    ...
                    <span className="inline-flex items-center gap-1 text-[11px] font-bold uppercase tracking-widest text-violet-600 dark:text-violet-400 opacity-0 group-hover:opacity-100 transition-all transform translate-x-2 group-hover:translate-x-0">
                        Ver detalle
